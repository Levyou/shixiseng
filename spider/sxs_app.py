...
def sxs_crawl(pages=30, kw='数据挖掘', c='全国'):
    ...
    job_list.to_csv(r'C:\Users\Mr.You\Desktop\interesting-python-master\shixiseng_packet_capture\job_list.csv', index=False)
    ...
    job_detailed.to_csv(r'C:\Users\Mr.You\Desktop\interesting-python-master\shixiseng_packet_capture\job_detailed.csv', index=False)
    ...
    com_detailed.to_csv(r'C:\Users\Mr.You\Desktop\interesting-python-master\shixiseng_packet_capture\com_detailed.csv', index=False)
